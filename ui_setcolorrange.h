...
public:
    ...
    void retranslateUi(QWidget *SetColorRange)
    {
        ...
        groupBox->setTitle(QApplication::translate("SetColorRange", "Min color", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("SetColorRange", "Max color", Q_NULLPTR));
    } // retranslateUi
