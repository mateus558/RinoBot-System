...
public:
    ...
    void setupUi(QWidget *video4linuxConfig)
    {
        ...
        pushButton_2 = new QPushButton(video4linuxConfig);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(150, 220, 89, 25));
    ...
    void retranslateUi(QWidget *video4linuxConfig)
    {
        ...
        pushButton_2->setText(QApplication::translate("video4linuxConfig", "Init Capture", Q_NULLPTR));
    } // retranslateUi
