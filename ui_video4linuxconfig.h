...
public:
    ...
    QPushButton *setToDefault;
    QPushButton *Init_Capture_btn;
    QLabel *gain_label;
    QSlider *gain_slider;
    QLCDNumber *gain_lcd;
    ...
    void setupUi(QWidget *video4linuxConfig)
    {
        ...
        video4linuxConfig->setWindowModality(Qt::ApplicationModal);
        video4linuxConfig->resize(1056, 505);
        ...
        white_bal_slider->setGeometry(QRect(140, 130, 160, 16));
        ...
        sharpness_slider->setGeometry(QRect(140, 160, 160, 16));
        ...
        exposure_slider->setGeometry(QRect(140, 190, 160, 16));
        ...
        focus_slider->setGeometry(QRect(140, 220, 160, 16));
        ...
        camera_view->setGeometry(QRect(390, 10, 640, 480));
        ...
        white_bal_lcd->setGeometry(QRect(310, 130, 64, 23));
        ...
        sharpness_lcd->setGeometry(QRect(310, 160, 64, 23));
        ...
        exposure_lcd->setGeometry(QRect(310, 190, 64, 23));
        ...
        focus_lcd->setGeometry(QRect(310, 220, 64, 23));
        focus_lcd->setStyleSheet(QStringLiteral("Background-Color: #000"));
        focus_lcd->setProperty("intValue", QVariant(250));
        setToDefault = new QPushButton(video4linuxConfig);
        setToDefault->setObjectName(QStringLiteral("setToDefault"));
        setToDefault->setGeometry(QRect(30, 330, 141, 91));
        Init_Capture_btn = new QPushButton(video4linuxConfig);
        Init_Capture_btn->setObjectName(QStringLiteral("Init_Capture_btn"));
        Init_Capture_btn->setGeometry(QRect(190, 330, 141, 91));
        gain_label = new QLabel(video4linuxConfig);
        gain_label->setObjectName(QStringLiteral("gain_label"));
        gain_label->setGeometry(QRect(20, 100, 91, 17));
        gain_slider = new QSlider(video4linuxConfig);
        gain_slider->setObjectName(QStringLiteral("gain_slider"));
        gain_slider->setGeometry(QRect(140, 100, 160, 16));
        gain_slider->setMaximum(255);
        gain_slider->setOrientation(Qt::Horizontal);
        gain_lcd = new QLCDNumber(video4linuxConfig);
        gain_lcd->setObjectName(QStringLiteral("gain_lcd"));
        gain_lcd->setGeometry(QRect(310, 100, 64, 23));
        gain_lcd->setStyleSheet(QStringLiteral("Background-Color: #000"));
        gain_lcd->setProperty("intValue", QVariant(255));
    ...
    void retranslateUi(QWidget *video4linuxConfig)
    {
        ...
        setToDefault->setText(QApplication::translate("video4linuxConfig", "Set to Default", Q_NULLPTR));
        Init_Capture_btn->setText(QApplication::translate("video4linuxConfig", "Init Capture", Q_NULLPTR));
        gain_label->setText(QApplication::translate("video4linuxConfig", "Gain:", Q_NULLPTR));
    } // retranslateUi
