...
public:
    ...
    {
        ConfigRobots->setWindowTitle(QApplication::translate("ConfigRobots", "Configure Robots", 0));
        label->setText(QApplication::translate("ConfigRobots", "Select Robot:", 0));
        label_2->setText(QApplication::translate("ConfigRobots", "Channel:", 0));
        label_3->setText(QApplication::translate("ConfigRobots", "Role:", 0));
        label_4->setText(QApplication::translate("ConfigRobots", "ID:", 0));
        configColorRange->setText(QApplication::translate("ConfigRobots", "Config Color Range", 0));
        save->setText(QApplication::translate("ConfigRobots", "Save", 0));
    } // retranslateUi
