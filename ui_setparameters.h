...
public:
    ...
    void setupUi(QMainWindow *SetParameters)
    {
        ...
        camera_video->setGeometry(QRect(20, 10, 771, 431));
        ...
        fps_number->setGeometry(QRect(900, 380, 64, 23));
        ...
        camera_label->setGeometry(QRect(830, 330, 101, 16));
        spinBox = new QSpinBox(centralwidget);
        spinBox->setObjectName(QStringLiteral("spinBox"));
        spinBox->setGeometry(QRect(830, 350, 47, 23));
        ...
        calibrate_camera->setGeometry(QRect(760, 450, 231, 41));
    ...
    void retranslateUi(QMainWindow *SetParameters)
    {
        ...
        initCapture->setText(QApplication::translate("SetParameters", "Init Capture", Q_NULLPTR));
        ...
        configRobots->setText(QApplication::translate("SetParameters", "Configure Robots", Q_NULLPTR));
        T1_color->setText(QApplication::translate("SetParameters", "Set team 1 color", Q_NULLPTR));
        T2_color->setText(QApplication::translate("SetParameters", "Set team 2 color", Q_NULLPTR));
        mapPoints->setText(QApplication::translate("SetParameters", "Set map points", Q_NULLPTR));
        attackArrea_btn->setText(QApplication::translate("SetParameters", "Set attack area", Q_NULLPTR));
        defenseArrea_btn->setText(QApplication::translate("SetParameters", "Set defense area", Q_NULLPTR));
        ball_color->setText(QApplication::translate("SetParameters", "Set ball color", Q_NULLPTR));
        camera_label->setText(QApplication::translate("SetParameters", "Select camera:", Q_NULLPTR));
        config_serial->setText(QApplication::translate("SetParameters", "Configure Serial", Q_NULLPTR));
        calibrate_camera->setText(QApplication::translate("SetParameters", "Calibrate Camera (Video4Linux)", Q_NULLPTR));
    } // retranslateUi
